function CVPreview({ generalInfo, educationInfo, workInfo }) {
	return (
		<div className="cv-preview">
						...
						<a
							href={
								generalInfo.linkedIn.startsWith("http")
									? generalInfo.linkedIn
									: `https://linkedin.com/in/${generalInfo.linkedIn}`
							}
							className="contact-link"
							target="_blank"
							rel="noopener noreferrer"
						...
						<a
							href={
								generalInfo.gitHub.startsWith("http")
									? generalInfo.gitHub
									: `https://github.com/${generalInfo.gitHub}`
							}
							className="contact-link"
							target="_blank"
							rel="noopener noreferrer"
			...
			{educationInfo &&
				...
				educationInfo.some(
					(edu) => edu.degree || edu.major || edu.school || edu.graduationDate
				) && (
			...
			{!generalInfo.firstName &&
				...
				(!educationInfo || !educationInfo.some((edu) => edu.degree)) &&
				(!workInfo || !workInfo.some((work) => work.position)) && (
					<div className="empty-cv">
						<p>
							Start filling out your information on the left to see your CV
							preview here!
						</p>
					</div>
				)}
